...
def generate_quiz_questions(theme, num_questions=2, num_options=4):
    ...
    prompt = (
        f"Genera una lista de {num_questions} preguntas, con cierto toque de sarcasmo por lo fácil de responder, en formato JSON para un quiz / trivia sobre '{theme}'. "
        f"El JSON debe incluir una pregunta principal corta usando un toque de sarcasmo y con el estilo MrBeast en la propiedad 'main_question' que aplique para todas las preguntas de la propiedad 'questions', "
