...
voices = [
    ...
    {"Engine": "neural", "LanguageCode": "fr-FR", "VoiceId": "Léa", "Gender": "Female", "TextType": "ssml", "Newscaster": ""},
    {"Engine": "standard", "LanguageCode": "fr-FR", "VoiceId": "Céline", "Gender": "Female", "TextType": "ssml", "Newscaster": ""},
    {"Engine": "standard", "LanguageCode": "fr-FR", "VoiceId": "Mathieu", "Gender": "Male", "TextType": "ssml", "Newscaster": ""},
    {"Engine": "neural", "LanguageCode": "fr-FR", "VoiceId": "Rémi", "Gender": "Male", "TextType": "ssml", "Newscaster": ""},
    {"Engine": "neural", "LanguageCode": "es-MX", "VoiceId": "Mia", "Gender": "Female", "TextType": "ssml", "Newscaster": ""},
    {"Engine": "neural", "LanguageCode": "es-MX", "VoiceId": "Andrés", "Gender": "Male", "TextType": "ssml", "Newscaster": ""},
    {"Engine": "neural", "LanguageCode": "pt-BR", "VoiceId": "Camila", "Gender": "Female", "TextType": "ssml", "Newscaster": ""},
    {"Engine": "neural", "LanguageCode": "pt-BR", "VoiceId": "Vitória", "Gender": "Female", "TextType": "ssml", "Newscaster": ""},
...
def create_background_video(background_video_path, duration):
    ...
    return background_clip.set_opacity(0.1)
