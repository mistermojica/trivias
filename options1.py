def add_options(options, video_clip, options_font_path, correct_option_index, start_time, margin=170, top_margin=1000):
    option_clips = []
    ...
    for i, option in enumerate(options):
        ...
        # Crear el fondo redondeado amarillo para la opción correcta
        if i == correct_option_index:
            ...
            composed_clip = CompositeVideoClip(
                [option_bg_clip, correct_option_bg_clip, circle_clip, label_clip, option_text_clip],
